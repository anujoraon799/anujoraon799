...
### 🔵 [Telecom Customer Retention Analysis — Python](https://github.com/anujoraon799/telecom-customer-retention-analysis)
...
**Core stack:**
SQL (Snowflake, Databricks, MySQL) · Python (Pandas, NumPy, Matplotlib, Seaborn) · Power BI (DAX, Data Modeling) · Advanced Excel · Tableau

**What I do with them:**
Customer segmentation · Churn analysis · Pricing & margin analysis · Promotional analytics · Sales performance reporting · A/B testing · EDA · KPI dashboards · Market segmentation

---

## 📋 Experience Snapshot

**Enterprise Insights Analyst — Giant Eagle GCC, Bengaluru** *(Rotational Program)*
Worked across four analytics functions over 9 months:
...
- **BCA** | St. Joseph's College, Darjeeling | 2022
